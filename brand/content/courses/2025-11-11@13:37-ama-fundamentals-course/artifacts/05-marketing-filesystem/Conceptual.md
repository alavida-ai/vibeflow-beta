...
**Try this after completing Class 5:**

1. **Audit your current structure**
   - List all files at your root
   - Identify which belong in research, strategy, or content
   - Find files with version numbers or "FINAL" in names

2. **Create the three base directories**
   ```
   /brand/
   ├── /research/
   ├── /strategy/
...
3. **Create one domain in each layer**
   - `/brand/research/customer-insights/`
   - `/brand/strategy/voice/`
   - `/brand/content/twitter-posts/`

4. **Move one file into proper structure**
   - Find a voice strategy doc
   - Create index: `/brand/strategy/voice/STRATEGY.md`
   - Create execution: `/brand/strategy/voice/2025-11-13@14:30/STRATEGY.md`
   - Practice the index vs execution pattern

5. **Create one markdown reference**
   - In a strategy doc, reference a research finding
   - Follow the audit trail (click the link to verify)

**The goal:** Experience the clarity of structured navigation before moving to Classes 6-7.
